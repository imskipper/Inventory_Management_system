...
(1, 'SIDDHANT SANGOLE', '123,MOON', 8547962154, 350000.00),
(2, 'Shubham Pethe', 'KHARBI CHOWK NAGPUR,440024', 7589654125, 950000.00);
...
(1, 'shubhamkpethe@gmail.com', '535459ac771f32c399074c86f69eebb9', 'Administrator', 'admin', 'Active');
...
ALTER TABLE `ims_product`
  MODIFY `pid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
